    ...
    while True:
        ...
        while l < len(data_x):
            ...
            if data_x_bak_ is not None \
                    ...
                    and l + batch_size - len(data_y_bak_)<=len(data_x):
                ...
                assert len(batch_y) == batch_size,'len(batch_y) != batch_size'
...
def read_data(train_data_dir, test_data_dir):
    ...
    #print('train_clients',train_clients)
    #print('test_clients',test_clients)
